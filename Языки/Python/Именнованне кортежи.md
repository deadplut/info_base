...
#### namedtuple
`namedtuple` - фабричная фнукция, которая строит подкласс [[Кортежи - tuple|tuple]] с заданными именами
```
...
При этом при наследовании класс Coordinate будет являться типом [[Кортежи - tuple|tuple]],
